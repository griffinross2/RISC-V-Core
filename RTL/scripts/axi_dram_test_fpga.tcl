    ...
    add_files -fileset sources_1 ./testbench/axi_dram_test_fpga.sv
    ...
    set_property top axi_dram_test_fpga [get_fileset sources_1]
    # set_property -name {xsim.simulate.log_all_signals} -value {true} -objects [get_filesets sim_1]
    
    # set_property xsim.view { ./waveforms/axi_dram_test_fpga.wcfg } [get_filesets sources_1]
