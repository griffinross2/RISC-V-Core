    ...
    add_files -fileset sim_1 ./testbench/axi_to_ahb_bridge_tb.sv
    
    add_files -fileset sim_1 -norecurse ./waveforms/axi_to_ahb_bridge_tb.wcfg
    ...
    set_property top axi_to_ahb_bridge_tb [get_fileset sim_1]
    set_property -name {xsim.simulate.log_all_signals} -value {true} -objects [get_filesets sim_1]
    
    set_property xsim.view { ./waveforms/axi_to_ahb_bridge_tb.wcfg } [get_filesets sim_1]
