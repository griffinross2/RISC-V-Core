    ...
    add_files -fileset sources_1 [ glob ./testbench/uart_loopback_fpga.sv ]
    ...
    set_property top uart_loopback_fpga [get_fileset sources_1]
    # set_property -name {xsim.simulate.log_all_signals} -value {true} -objects [get_filesets sim_1]
    
    # set_property xsim.view { ./waveforms/uart_loopback_fpga.wcfg } [get_filesets sources_1]
