    ...
    add_files -fileset sim_1 ./testbench/axi_controller_tb.sv
    
    add_files -fileset sim_1 -norecurse ./waveforms/axi_controller_tb.wcfg
    ...
    set_property top axi_controller_tb [get_fileset sim_1]
    set_property -name {xsim.simulate.log_all_signals} -value {true} -objects [get_filesets sim_1]
    
    set_property xsim.view { ./waveforms/axi_controller_tb.wcfg } [get_filesets sim_1]
