    ...
    add_files -fileset sources_1 ./source/rom.sv
    add_files -fileset sources_1 ./source/axi_controller.sv
    add_files -fileset sources_1 ./source/axi_rom_controller.sv
    add_files -fileset sim_1 ./testbench/axi_rom_controller_tb.sv
    
    # add_files -fileset sim_1 -norecurse ./waveforms/axi_rom_controller_tb.wcfg
    ...
    set_property top axi_rom_controller_tb [get_fileset sim_1]
    set_property -name {xsim.simulate.log_all_signals} -value {true} -objects [get_filesets sim_1]
    
    # set_property xsim.view { ./waveforms/axi_rom_controller_tb.wcfg } [get_filesets sim_1]
