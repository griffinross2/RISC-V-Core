    ...
    add_files -fileset sim_1 -norecurse ./waveforms/divider_tb.wcfg
    ...
    set_property top divider_tb [get_fileset sim_1]
    set_property -name {xsim.simulate.log_all_signals} -value {true} -objects [get_filesets sim_1]
    
    set_property xsim.view { ./waveforms/divider_tb.wcfg } [get_filesets sim_1]
