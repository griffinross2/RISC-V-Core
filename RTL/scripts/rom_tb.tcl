    ...
    add_files -fileset sim_1 -norecurse ./waveforms/rom_tb.wcfg
    ...
    set_property top rom_tb [get_fileset sim_1]
    set_property -name {xsim.simulate.log_all_signals} -value {true} -objects [get_filesets sim_1]
    
    set_property xsim.view { ./waveforms/rom_tb.wcfg } [get_filesets sim_1]
